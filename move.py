class Move:
    ...
    def execute(self, game_state):
        ...
        if not self._start is self._end:
            self._end.piece = self._start.piece
            if isinstance(self._end.piece, Pawn) and self._end.piece._first_move:
                self._end.piece._first_move = False# move to new space
